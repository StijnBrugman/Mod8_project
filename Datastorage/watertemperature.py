...
for i in range(len(start_date_list)):
    ...
    time.sleep(2)
    waterkwantiteit = driver.find_element_by_xpath("/html/body/nav/div[4]/div[7]/div[1]/div[1]/form/ul/li[2]/button[1]").click()
    time.sleep(1)
    watertemperatuur = driver.find_element_by_xpath("/html/body/nav/div[4]/div[7]/div[1]/div[1]/form/ul/li[2]/ul/li[6]/button").click()
    time.sleep(1)
    watertemperatuurgraden = driver.find_element_by_xpath("/html/body/nav/div[4]/div[7]/div[1]/div[1]/form/ul/li[2]/ul/li[6]/ul/li[2]/label").click()
    time.sleep(1)
    ...
    start_dates.send_keys(start_date_list[i])
    time.sleep(1.5)
    ...
    end_dates.send_keys(end_date_list[i])
    time.sleep(.5)
    ...
    time.sleep(1)
    searches.send_keys("Rotterdam")
    time.sleep(2)
    driver.find_element_by_xpath('//*[@id="list-location-checkbox-Rotterdam(ROTTDM)"]').click()
